...
public class MainActivity extends AppCompatActivity
    ...
    private static final String ACTION_MEETING = "com.marktony.translator.meeting";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (savedInstanceState != null) {
            ...
            meetingFragment = (MeetingFragment) manager.getFragment(savedInstanceState,"meetingFragment");
        ...
        manager.beginTransaction()
                .add(R.id.container_main, meetingFragment, "meetingFragment")
                .commit();


        Intent intent = getIntent();
        if(intent.getAction().equals(ACTION_MEETING)){
            showHideFragment(3);
    ...
    protected void onSaveInstanceState(Bundle outState) {
        ...
        if (meetingFragment.isAdded()) {
            getSupportFragmentManager().putFragment(outState, "meetingFragment", meetingFragment);
        }
    ...
    private void showHideFragment(@IntRange(from = 0, to = 3) int position) {
        ...
        FragmentManager manager = getSupportFragmentManager();
        manager.beginTransaction().hide(meetingFragment).commit();
        ...
        if (position == 0) {
            ...
            toolbar.setTitle("会议");
            manager.beginTransaction().show(meetingFragment).commit();
            navigationView.setCheckedItem(R.id.nav_meeting);
        }
